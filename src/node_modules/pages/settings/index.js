...
const Settings = () => {
  const [currentUserState, dispath] = useContext( CurrentUserContext );
  const apiUrl = '/user';
  ...
  const [isSuccsessfullLogout, setIsSuccsessfullLogout] = useState(false);
