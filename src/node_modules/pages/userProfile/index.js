...
const UserProfile = () => {
  ...
  const isFavorites = local.pathname.endsWith('/favorites') && local.pathname !== '/profiles/favorites';
      ...
      <div className="profile-page">
        <div className="user-info">
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-ms-10 offset-md-1">
                <img src={response.profile.image} alt="imageUser"
                     className="user-img"/>
